...
test("desktop web shell exposes sidebar brand, search and large-screen overrides", () => {
  ...
  assert.match(html, /khoan-da-2026\.css\?v=20260801-mobile-check-fix-2/);
  assert.match(serviceWorker, /khoan-da-shell-v44/);
  assert.match(serviceWorker, /khoan-da-2026\.css\?v=20260801-mobile-check-fix-2/);
