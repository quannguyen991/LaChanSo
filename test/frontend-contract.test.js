...
test("desktop web shell exposes sidebar brand, search and large-screen overrides", () => {
  ...
  assert.match(html, /khoan-da-2026\.css\?v=20260731-taskbar-marker-fix-1/);
  assert.match(serviceWorker, /khoan-da-shell-v38/);
  assert.match(serviceWorker, /khoan-da-2026\.css\?v=20260731-taskbar-marker-fix-1/);
